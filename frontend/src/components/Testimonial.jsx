  ...
  const cardsData = [
    {
      image: assets.user1,
      name: 'Sujal Shrestha',
      handle: '@sujalshrestha',
      date: 'April 20, 2025',
      testimonial: "This platform has completely changed how I connect with others. The interface is smooth, and the support is incredible!"
    },
    {
      image: assets.user2,
      name: 'Samiksha Shrestha',
      handle: '@samikshashrestha',
      date: 'May 10, 2025',
      testimonial: "I love using this service! It's reliable and makes everything so much easier. Highly recommended!"
    },
    {
      image: assets.user3,
      name: 'Sujan Gurung',
      handle: '@sujang',
      date: 'June 5, 2025',
      testimonial: "Amazing experience! The features are thoughtfully designed and really practical for everyday use."
    },
    {
      image: assets.user4,
      name: 'Bikram Thapa',
      handle: '@bikramt',
      date: 'May 10, 2025',
      testimonial: "I appreciate how user-friendly this platform is. It saves me so much time and effort."
    }
  ];
