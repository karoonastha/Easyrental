...
export const createNewProperty = async (req, res) => {
    try {
        ...
        const agency = await Agency.fineOne({ owner: req.auth.userId })
        ...
        //Waitings for upload to complete
...
//Get property of the logged-in owner [GET '/properties/owner']
...
//Toggle availability status of property [POST'/properties/toggle-availability']
